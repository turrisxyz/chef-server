...
chmod 766 /opt/opscode/embedded/opensearch/plugins/opensearch-security/tools/hash.sh
chmod 766 /opt/opscode/embedded/opensearch/plugins/opensearch-security/tools/securityadmin.sh
